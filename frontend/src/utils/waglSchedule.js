...
export const WAGL_SCHEDULE = [
  { event: 1,  date: '2026-04-16', time: '4:16 PM',  course: "The Barn", contest: "Closest to the hole & Long putt" },
  { event: 2,  date: '2026-04-23', time: '4:10 PM',  course: "Glen Eagle", contest: "Handicap" },
  { event: 3,  date: '2026-04-30', time: '4:10 PM',  course: "Schneiter's Bluff", contest: "Closest to the hole & Long putt" },
  { event: 4,  date: '2026-05-07', time: '4:10 PM',  course: "Mt. Ogden", contest: "Handicap" },
  { event: 5,  date: '2026-05-14', time: '4:10 PM',  course: "Sun Hills", contest: "Closest to the hole & Long putt" },
  { event: 6,  date: '2026-05-21', time: '4:10 PM',  course: "Lakeside", contest: "Handicap" },
  { event: 7,  date: '2026-05-28', time: '4:19 PM',  course: "Davis Park", contest: "Closest to the hole & Long putt" },
  { event: 8,  date: '2026-06-04', time: '4:10 PM',  course: "Valley View", contest: "Handicap" },
  { event: 9,  date: '2026-06-11', time: '4:10 PM',  course: "Crane Field", contest: "Closest to the hole & Long putt" },
  { event: 10, date: '2026-06-18', time: '4:10 PM',  course: "Schneiter's Riverside", contest: "Handicap" },
  { event: 11, date: '2026-07-09', time: '4:10 PM',  course: "Schneiter's Bluff", contest: "Closest to the hole & Long putt" },
  { event: 12, date: '2026-07-16', time: '4:10 PM',  course: "Mt. Ogden", contest: "Handicap" },
  { event: 13, date: '2026-07-23', time: '4:19 PM',  course: "Davis Park", contest: "Closest to the hole & Long putt" },
  { event: 14, date: '2026-07-30', time: '4:10 PM',  course: "Schneiter's Riverside", contest: "Handicap" },
  { event: 15, date: '2026-08-06', time: '4:10 PM',  course: "Crane Field", contest: "Closest to the hole & Long putt" },
  { event: 16, date: '2026-08-13', time: '4:10 PM',  course: "Lakeside", contest: "Handicap" },
  { event: 17, date: '2026-08-20', time: '4:10 PM',  course: "Valley View", contest: "Closest to the hole & Long putt" },
  { event: 18, date: '2026-08-27', time: '4:20 PM',  course: "Glen Eagle", contest: "Handicap" },
  { event: 19, date: '2026-09-03', time: '4:10 PM',  course: "The Barn", contest: "Closest to the hole & Long putt" },
  { event: 20, date: '2026-09-10', time: '4:16 PM',  course: "Sun Hills", contest: "Handicap" },
]
